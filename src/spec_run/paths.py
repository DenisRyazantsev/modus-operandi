...
launcher leftovers that ``spec-run uninstall`` cleans up.
"""
...
def _layout(base: Path) -> Paths:
    return {
        ...
        "config_dir": base / "spec-run",
        "config": base / "spec-run" / "config.yml",
        "config_example": base / "spec-run" / "config.example.yml",
        "install_version": base / "spec-run" / "install-version.txt",
        "review_workflow": base / "spec-run" / "review-pipeline.yml",
        "task_workflow": base / "spec-run" / "task-pipeline.yml",
        "prompts": base / "spec-run" / "prompts",
        ...
        "run_agent_cursor": (
            base / "opencode" / "scripts" / "run-agent-cursor.sh"
        ),
        ...
        "run_pipeline_common": (
            base / "opencode" / "scripts" / "_run_pipeline_common.py"
        ),
        ...
        "config_invocation": (
            base / "opencode" / "scripts" / "config_invocation.py"
        ),
        "run_statistics": (
            base / "opencode" / "scripts" / "run_statistics.py"
        ),
        "latency_table": (
            base / "opencode" / "scripts" / "latency_table.py"
        ),
        "notify": base / "opencode" / "scripts" / "notify.py",
        "feedback_editor": (
            base / "opencode" / "scripts" / "feedback_editor.py"
        ),
        ...
        "check_implementation": (
            base / "opencode" / "scripts" / "check_implementation.py"
        ),
        ...
        "implement_pass_check": (
            base / "opencode" / "scripts" / "implement-pass-check.sh"
        ),
