...
1. **Write ADRs.** When asked to plan a feature, write the ADR file (`.workflow/tasks/<task-id>/adr.md`) with these sections: Context, Decision, Alternatives, Consequences, Acceptance Criteria. Ground the decision in the described feature, be specific enough for a cheap model to implement without re-asking, and keep it minimal.
