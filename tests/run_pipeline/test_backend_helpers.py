...
class BackendSelectionTest(unittest.TestCase):
    ...
    def test_effective_backend_defaults_to_opencode(self):
    ...
    def test_effective_backend_reads_config(self):
        mod = load_run_pipeline()
        self.assertEqual(mod.effective_backend({"backend": "cursor"}, None), "cursor")

    def test_effective_backend_cli_flag_wins(self):
        mod = load_run_pipeline()
    ...
    def test_normalize_config_folds_legacy_models(self):
        mod = load_run_pipeline()
    ...
    def test_role_model_empty_when_section_missing(self):
        mod = load_run_pipeline()
