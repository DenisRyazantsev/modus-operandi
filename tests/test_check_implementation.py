...
def run_with_side_effect(side_effect):
...
class HasChangesTest(unittest.TestCase):
    ...
    def test_untracked_new_file(self):
    ...
    def test_only_saved_adr_is_not_a_change(self):
...
class ExitCodeTest(unittest.TestCase):
    def test_changes_exit_zero_no_changes_exit_one(self):
        codes = []
        with (
            mock.patch.object(
